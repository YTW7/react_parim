 ...
 */
export declare function sendCreateParimutuelTransaction(this: ParimutuelWeb3, userWallet: WalletSigner | Keypair, marketPubkey: PublicKey, marketOpen: number, timeWindowStart: number, marketClose: number): Promise<string>;
